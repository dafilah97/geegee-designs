          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
            ...
            >
              ...
              <div className="prose prose-sm text-gray-600 font-light leading-relaxed">
                <p>
                  Born in the vibrant heart of Maun, Botswana, GeeGee Designs is a celebration of love, culture, and meticulous craftsmanship. We believe that a wedding gown is more than just a dress; it is a profound expression of a woman's journey and heritage.
                </p>
                <p>
